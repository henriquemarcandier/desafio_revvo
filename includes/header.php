        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="" class="text-sm font-medium hover:text-primary transition-colors <?php echo basename($_SERVER['PHP_SELF']) === 'index.php' ? 'text-primary' : 'text-slate-600' ?>">Início</a>
                    <a href="cursos" class="text-sm font-medium hover:text-primary transition-colors <?php echo basename($_SERVER['PHP_SELF']) === 'cursos.php' ? 'text-primary' : 'text-slate-600' ?>">Cursos</a>
                    <a href="sobre" class="text-sm font-medium hover:text-primary transition-colors">Sobre</a>
                    <a href="contato" class="text-sm font-medium hover:text-primary transition-colors">Contato</a>
                </nav>

                <!-- Auth Buttons (Desktop) -->
                <div class="hidden md:flex items-center space-x-4">
                    <a href="login" class="text-sm font-medium text-slate-600 hover:text-primary transition-colors">Entrar</a>
                    <a href="registrar" class="px-4 py-2 bg-primary text-white text-sm font-medium rounded-md hover:bg-blue-700 transition-colors shadow-sm">
                        Criar conta
                    </a>
                </div>
